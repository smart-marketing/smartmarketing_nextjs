...
import { CheckCircle, XCircle, Users, Banknote, Target, TrendingUp, Clock, ShoppingCart, User, Sparkles, DollarSign, Zap, ArrowRight } from 'lucide-react'

export default function SmartLeadsTarget() {
  ...
  const idealFor = [
    {
      ...
      title: "Masz proces sprzedażowy",
      description: "prowadzisz konsultacje, prezentacje, wyceny przed sprzedażą"
    },
    {
      icon: <Banknote className="w-5 h-5" />,
      title: "Sprzedajesz usługi/produkty 3k+",
      description: "wysokie marże pozwalają na efektywne kampanie"
    },
    {
    ...
    {
      icon: <Users className="w-5 h-5" />,
      title: "Masz zespół sprzedaży",
      description: "siebie lub pracowników którzy obsłużą leadów"
    },
    {
      icon: <TrendingUp className="w-5 h-5" />,
      title: "Myślisz długoterminowo",
      description: "budujesz system, nie szukasz szybkich efektów"
    },
    {
      icon: <Target className="w-5 h-5" />,
      title: "Chcesz kontrolować jakość",
      description: "wolisz mniej leadów ale jakościowych"
    }
  ]
  ...
  const notFor = [
    {
      ...
      title: "Nie masz procesu sprzedażowego",
      description: "sprzedajesz przez e-commerce lub bezpośrednio online"
    },
    {
      icon: <Banknote className="w-5 h-5" />,
      title: "Sprzedajesz tanie usługi",
      description: "(poniżej 1000 zł) - zbyt niskie marże na efektywne kampanie"
    },
    {
      icon: <User className="w-5 h-5" />,
      title: "Budujesz markę osobistą",
      description: "masz inne potrzeby marketingowe"
    },
    {
      icon: <Sparkles className="w-5 h-5" />,
      title: "Działasz w branży beauty/wellness",
      description: "z tanimi usługami - lepiej sprawdzi się social media"
    },
    {
      icon: <DollarSign className="w-5 h-5" />,
    ...
    },
    {
      ...
      description: "SmartLeads to system długoterminowy"
    }
  ]
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-[#333333]">
            DLA KOGO JEST <span className="bg-gradient-to-r from-[#C11369] to-[#049FE3] bg-clip-text text-transparent">SMARTLEADS</span>
          </h2>
        </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-white rounded-3xl p-8 h-full border border-green-200">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-[#333333]">
                    SmartLeads <span className="text-green-600">IDEALNIE PASUJE</span> jeśli:
                  </h3>
                </div>
            ...
            <div className={`transition-all duration-700 ${
              ...
              <div className="bg-gradient-to-br from-red-50 to-white rounded-3xl p-8 h-full border border-red-200">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-[#333333]">
                    SmartLeads <span className="text-red-600">NIE JEST DLA CIEBIE</span> jeśli:
                  </h3>
                </div>
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-900 ${
          ...
          <div className="bg-gradient-to-r from-gray-100 to-gray-50 rounded-3xl p-8 max-w-3xl mx-auto">
            <p className="font-heading text-xl font-semibold text-[#333333] mb-6">
              Nie jesteś pewny czy SmartLeads do Ciebie pasuje?
              <br />
              <span className="text-2xl bg-gradient-to-r from-[#C11369] to-[#049FE3] bg-clip-text text-transparent">
